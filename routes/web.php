...
Route::post('deposit/paygate-return-url', 'Users\DepositController@paygateReturnResponse');
Route::get('deposit/paygate-payment-success', 'Users\DepositController@paygatePaymentSuccess');
...

{
    ...
    Route::get('/download-qr-code', 'CustomerController@downloadQrCode')->name('download.qr.code');
...

    {
        ...
        //Paygate
        Route::get('deposit/paygate', 'DepositController@paygate');
        Route::post('deposit/paygate-payment', 'DepositController@paygatePayment');
    });
...

    {
        ...
        Route::post('qr-code-scan', 'MoneyTransferController@scanQrCode')->name('user.send_money.qrscan');
...
// Merchant payment using Paygate
Route::match(array('GET', 'POST'), 'merchant/wallet-payment/{grantId?}/{token?}', 'MerchantApiPayment@merchantWalletPayment');
Route::post('merchant/api/paygate', 'MerchantApiPayment@paygatePaymentForm');
Route::post('merchant/api/paygate-payment', 'MerchantApiPayment@paygatePayment');
Route::post('merchant/api/paygate-payment/success', 'MerchantApiPayment@paygateSuccessPayment')->name('paygate.payment.success');
Route::get('merchant/api/paygate-payment/cancel', 'MerchantApiPayment@paygateCancelPayment');
