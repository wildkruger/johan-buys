    ...
    <div class="box-body no-padding">
        ...
        <ul class="nav nav-pills nav-stacked flex-column">
            ...
            @if ($currency->code == 'ZAR')
                <li {{ isset($list_menu) && $list_menu == 'profile_payment' ? 'class=active' : '' }}>
                    <a data-spinner="true" href='{{ url(\Config::get('adminPrefix') . '/settings/feeslimit/profile_payment/' . $currency->id) }}'>{{ __('Profile Payment') }}</a>
                </li>
            @endif
