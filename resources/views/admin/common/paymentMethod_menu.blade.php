        ...
        <ul class="nav nav-pills nav-stacked flex-column">
            ...
            @if ($currency->type == 'fiat')
                ...
                @if($currency->code == 'ZAR')
                    <li {{ isset($list_menu) && $list_menu == 'paygate' ? 'class=active' : '' }}>
                        <a data-spinner="true" href='{{ url(\Config::get('adminPrefix') . '/settings/payment-methods/paygate/' . $currency->id) }}'>{{ __('PayGate') }}</a>
                    </li>
                @endif
