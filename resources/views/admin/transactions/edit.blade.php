                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    @php
                                                        if($transaction->transaction_type->name == "Withdrawal"){
                                                            $type = "Payout";
                                                        } elseif($transaction->transaction_type->name == "Profile_payment"){
                                                            $type = 'Payment received';
                                                        } else {
                                                            $type = str_replace('_',' ',$transaction->transaction_type->name);
                                                        }
                                                    @endphp
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        @else
                                                            ...
                                                            <select class="form-control select2 w-60" name="status">
                                                                ...
                                                                @elseif (module('MerchantPayLink') && $transaction->transaction_type_id == Profile_payment)
                                                                    @if ($transaction->status == 'Success')
                                                                        <option value="Success" {{ $transaction->status == 'Success' ? 'selected' : '' }}>{{ __('Success') }}</option>
                                                                    @else
                                                                        <option value="Success" {{ $transaction->status == 'Success' ? 'selected' : '' }}>{{ __('Success') }}</option>
