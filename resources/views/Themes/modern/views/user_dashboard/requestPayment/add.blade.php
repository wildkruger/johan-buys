                                        ...
                                        <div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="cold-md-3">
                                                        <a class="btn btn-primary px-4 py-2" id="scan-qr"><i class="fa fa-qrcode" aria-hidden="true"></i> Scan QR</a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mb-2" id="qr-reader" width="600px"></div>
...
<script src="{{ theme_asset('public/js/html5-qrcode.min.js') }}" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    let qrScanUrl = "{{ route('user.send_money.qrscan') }}";
    ...
    function makeAjaxCall(decodedText)
    {
        $.ajax({
            method: "POST",
            url: qrScanUrl,
        ...
        .done(function (response)
        {
            ...
            var userType = records.userType;
            var receiverEmail = records.receiverEmail;
            var resultContainer = document.getElementById('requestCreatorEmail');
            resultContainer.value = receiverEmail;
        ...
        .fail(function (error) {
            ...
            $('.requestCreatorEmailOrPhoneError').html('Not a valid QrCode, scan again');
        });
