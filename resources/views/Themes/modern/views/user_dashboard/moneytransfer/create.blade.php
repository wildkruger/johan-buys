                                    ...
                                    <div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            onkeyup="this.value = this.value.replace(/\s/g, '')">
                                                    <span class="receiverError error"></span>
                                                    <small id="emailHelp" class="form-text text-muted"></small>
                                                </div>
                                                <div class="col-md-3">
                                                    <a class="btn btn-primary px-4 py-2" id="scan-qr"><i class="fa fa-qrcode" aria-hidden="true"></i>
                                                        Scan QR</a>
                                                </div>
                                            </div>
...
<script>
    ...
    var resultContainer = document.getElementById('receiver');
    ...
    function makeAjaxCall(decodedText)
    {
        ...
        .fail(function (error) {
            ...
            $('.receiverError').html('Not a valid QrCode');
        });
