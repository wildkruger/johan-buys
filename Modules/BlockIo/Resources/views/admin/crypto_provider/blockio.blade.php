                                            ...
                                            <div class="crypto-card">
                                                ...
                                                <div class="crypto-card-header">
                                                    <span class="crypto-logo text-center">
                                                        @if (!empty(optional($cryptoAsset->currency)->logo) && file_exists(public_path('uploads/currency_logos/' . $cryptoAsset->currency->logo)))
                                                            <img src="{{ asset('public/uploads/currency_logos/' . $cryptoAsset->currency->logo) }}" alt="Currency Logo">
                                                        @else
