        ...
        return datatables()
            ...
            ->addColumn('receiver', function ($transaction) {
                ...
                switch ($transaction->transaction_type_id) {
                    ...
                    case Payment_Received:
                    case (module('MerchantPayLink') ? Profile_payment : false):
                    case (module('BlockIo') ? Crypto_Received : false):
            ...
            ->editColumn('transaction_type_id', function ($transaction) {
                $transaction_type = str_replace('_',' ',$transaction->transaction_type->name) == 'Profile payment' ? 'Payment received' : __(str_replace('_',' ',$transaction->transaction_type->name));
                return (isset($transaction->transaction_type->name) && !empty($transaction->transaction_type->name)) ? $transaction_type : '-';
