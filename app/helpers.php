...
if (!function_exists('getStatusInputLabel')) {
...

    {
        ...
        $transactionTypes = [
            ...
            Profile_payment => ['user' => 'User', 'receiver' => 'Receiver']
        ...
        $array = [
            ...
            'transaction_types' => [
                ...
                'web' => [
                    ...
                    'received' => [Received, Request_To, Payment_Received, Profile_payment]
                ...
                'mobile' => [
                    ...
                    'received' => ['Received' => Received, 'Request_To' => Request_To, 'Payment_Received' => Payment_Received, 'Profile_payment' => Profile_payment]
            ...
            'payment_methods' => [
                ...
                'web' => [
                    ...
                    'all' => [Mts, Stripe, Paypal, PayUmoney, Bank, Coinpayments, Payeer, Crypto, Paygate],

                    'deposit' => [Mts, Stripe, Paypal, PayUmoney, Bank, Coinpayments, Payeer, Paygate],

                    'withdrawal' => [Paypal, Bank, Crypto],

                    'profile_payment' => [Paygate],
