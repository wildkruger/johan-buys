...
class SendMoneyService
{
    ...
    public function getSelfCurrencies()
    {
        ...
        Wallet::with('currency:id,code,type')
            ...
            ->where('fees_limits.transaction_type_id', Transferred)
            ->get()
    ...
    public function validateAmountLimit($currencyId, $amount)
    {
        ...
        if ($wallet->balance < $checkAmountWithFees) {
            throw new SendMoneyException(__("Sorry, not have enough funds to operate."));
        }
        ...
        if ($minError && $maxError) {
            throw new SendMoneyException(__("The maximum acceptable amount is :x and the minimum acceptable amount is :y.", [
            ...
            throw new SendMoneyException(__(
                "The maximum acceptable amount is :x.",
                [
                    "x" => formatNumber($currencyFee->max_limit, optional($currencyFee->currency)->id)
                ]
            ));
            ...
            throw new SendMoneyException(__(
                "The minimum acceptable amount is :x.",
                [
