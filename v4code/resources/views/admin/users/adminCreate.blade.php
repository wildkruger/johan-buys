                ...
                <form action="{{ url(config('adminPrefix').'/admin-users/store') }}" class="form-horizontal" id="user_form" method="POST">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 control-label mt-11 f-14 fw-bold text-sm-end" id="first_name">{{ __('First Name') }}</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 control-label mt-11 f-14 fw-bold text-sm-end" id="last_name">{{ __('Last Name') }}</label>
                            <div class="col-sm-6">
                                <input class="form-control f-14" placeholder="{{ __('Enter Last Name') }}" name="last_name" type="text" id="last_name" value="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 control-label mt-11 f-14 fw-bold text-sm-end require" id="email">{{ __('Email') }}</label>
                            <div class="col-sm-6">
                        ...
                        {{-- Role --}}
                        <div class="form-group row">
                            <label class="col-sm-3 control-label mt-11 f-14 fw-bold text-sm-end require" id="role">{{ __('Group') }}</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 control-label mt-11 f-14 fw-bold text-sm-end require" id="password">{{ __('Password') }}</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 control-label mt-11 f-14 fw-bold text-sm-end require" id="password_confirmation">{{ __('Confirm Password') }}</label>
                            <div class="col-sm-6">
