            ...
            <form id="edit-bank" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <label class="f-14 fw-bold mb-1" id="edit_default">{{ __('Default') }}</label>
                            ...
                            <div class="form-group">
                                <label class="f-14 fw-bold mb-1 mt-28" id="edit_account_name">{{ __('Bank Account Holder\'s Name') }}</label>
