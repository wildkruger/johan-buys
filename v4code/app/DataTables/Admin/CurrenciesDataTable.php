        ...
        return datatables()
            ...
            ->addColumn('action', function ($currency) {
                ...
                if ($currency->type == 'crypto_asset') {
                    $edit = (Common::has_permission(auth('admin')->user()->id, 'edit_currency')) ? '<a href="' . url(config('adminPrefix').'/blockio/edit/' . encrypt($currency->code)) . '" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a>&nbsp;' : '';
                } else {
