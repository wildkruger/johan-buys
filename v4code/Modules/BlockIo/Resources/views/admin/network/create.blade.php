    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info" id="blockio-asset-create">
                ...
                <form action="{{ route('admin.blockio_asset.store') }}" method="POST" class="row form-horizontal" enctype="multipart/form-data" id="add-blockio-network-form">
                    @csrf
                    <div class="box-body">
                        <!-- Name -->
                        ...
                        <div class="form-group align-items-center row">
                            <label class="col-sm-3 control-label f-14 fw-bold text-sm-end" for="pin">{{ __('PIN') }}</label>
                            <div class="col-sm-6">
                                <input class="form-control f-14 pin" name="pin" type="text" placeholder="{{ __('Please enter valid pin') }}" value="{{ old('pin') }}" id="pin" required data-value-missing="{{ __("This field is required.") }}">
                        ...
                        <!-- Merchant Address -->
                        <div class="form-group align-items-center row">
                            <label class="col-sm-3 control-label f-14 fw-bold text-sm-end" for="address">{{ __('Merchant Address') }}</label>
                            <div class="col-sm-6">
                                <input class="form-control f-14 address" name="address" type="text" placeholder="{{ __('Please enter valid merchant address') }}" value="{{ old('address') }}" id="address" required data-value-missing="{{ __("This field is required.") }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 offset-md-3">
                                ...
                                @if (Common::has_permission(auth('admin')->user()->id, 'add_crypto_asset'))
                                    <button type="submit" class="btn btn-theme f-14" id="blockio-settings-submit-btn">
